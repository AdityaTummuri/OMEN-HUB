...
DefinitionBlock ("", "SSDT", 2, "HPQOEM", "8BCD    ", 0x00000001)
{
    ...
    External (_SB_.PCI0.LPC0.EC0_.F6FL, FieldUnitObj)
    External (_SB_.PCI0.LPC0.EC0_.UWAK, FieldUnitObj)
    External (_SB_.PCI0.LPCB.BAT1, DeviceObj)
