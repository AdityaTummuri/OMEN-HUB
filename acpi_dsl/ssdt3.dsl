 ...
 */
DefinitionBlock ("", "SSDT", 2, "HPQOEM", "8BCD    ", 0x00000002)
{
    Scope (\_SB)
    {
        ...
        BankField (A168, A169, 0x03B10528
, DWordAcc, Lock, Preserve)
        ...
        BankField (A168, A169, 0x03B10578
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A146,   32
        ...
        BankField (A168, A169, 0x03B10998
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A147,   32
        ...
        BankField (A168, A169, 0x03B1099C
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A148,   32
        ...
        BankField (A168, A169, 0x03B109A0
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A149,   32
        ...
        BankField (A168, A169, 0x03B109A4
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A150,   32
        ...
        BankField (A168, A169, 0x03B109A8
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A151,   32
        ...
        BankField (A168, A169, 0x03B109AC
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A152,   32
        ...
        BankField (A168, A169, 0x13B00084
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A128,   32
        ...
        BankField (A168, A169, 0x11140280
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A129,   32
        ...
        BankField (A168, A169, 0x11141280
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A130,   32
        ...
        BankField (A168, A169, 0x11142280
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A131,   32
        ...
        BankField (A168, A169, 0x11143280
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A132,   32
        ...
        BankField (A168, A169, 0x11144280
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A133,   32
        ...
        BankField (A168, A169, 0x11240280
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A134,   32
        ...
        BankField (A168, A169, 0x11241280
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A135,   32
        ...
        BankField (A168, A169, 0x11242280
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A136,   32
        ...
        BankField (A168, A169, 0x11243280
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A137,   32
        ...
        BankField (A168, A169, 0x11244280
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A138,   32
        ...
        BankField (A168, A169, 0x11245280
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A139,   32
        ...
        BankField (A168, A169, 0x11140294
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A175,   32
        ...
        BankField (A168, A169, 0x11141294
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A176,   32
        ...
        BankField (A168, A169, 0x11142294
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A177,   32
        ...
        BankField (A168, A169, 0x11143294
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A178,   32
        ...
        BankField (A168, A169, 0x0C9109C8
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A160,   32
        ...
        BankField (A168, A169, 0x0C9109CC
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A161,   32
        ...
        BankField (A168, A169, 0x0C9109D0
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A162,   32
        ...
        BankField (A168, A169, 0x0C9109D4
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A163,   32
        ...
        BankField (A168, A169, 0x0C9109D8
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A164,   32
        ...
        BankField (A168, A169, 0x0C9109DC
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A165,   32
        ...
        BankField (A168, A169, 0x0C9109E0
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A166,   32
        ...
        BankField (A168, A169, 0x0C910554
, DWordAcc, Lock, Preserve)
        {
            Offset (0xA4), 
            A167,   32
